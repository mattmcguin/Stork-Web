<?php
    ...
    $subj = "Subscription Receipt!";
    $msg = "Hello " . $_SESSION['payerFirstName'] . " " . $_SESSION['payerLastName'] . 
    ", \nThank you for your subscription to Stork. The details of your order are below! 
    \n Payment ID: " . $_SESSION['paymentID'] . 
    "\nTransaction ID: " . $_SESSION['transactionID'] . 
    "\nTotal Amount: " . $_SESSION['finalAmount'] . 
    "\nSincerly,\n Stork Team";
