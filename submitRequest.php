<?php
    ...
    $subj = "Request has been placed!";
    $msg = $_POST['name'] . ", \n \n Your order has been placed and will hopefully be fulfilled soon! \n \n" .
    "Name: " . $_POST['name'] .
    "\nCompensation: " . $_POST['money'] . 
    ...
    $mail->addAddress('storkecommerce@gmail.com');
    $mail->SetFrom($sender);
    $mail->Subject = "$subj";
    $mail->Body = "$msg";
