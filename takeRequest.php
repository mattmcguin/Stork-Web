<?php
    ...
    $subj = "You have Taken the Request!";
    $msg = "You have taken the following request! Please contact the other stork to work out delivery. \n \n" .
    "\nEmail: " . $_POST['email'] .
    "\nCompensation: " . $_POST['price'] . 
    ...
    $subj = "A Stork has taken your Request!";
    $msg = "A Stork has taken your following request! Please contact him to work out the details. \n \n" .
    ...
    $receiver = "storkdeliverycompany@gmail.com";
    $subj = "Update Open Requests!";
    $msg = "Update the following request: \n \n" .
    "\nCompensation: " . $_POST['price'] . 
    "\nLocation: " . $_POST['location'] . 
    "\nCategory: " . $_POST['category'] . 
    "\nPriority: " . $_POST['priority'] . 
